    ...
    <div>
          ...
          <div className="relative w-[50%] h-full overflow-hidden">
            ...
            <div className="absolute inset-0 flex justify-center items-center z-40 ml-5">
              <div className="bg-white rounded-full shadow-md p-4 flex items-center w-[45%] h-[15%]">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="4.0" stroke="currentColor" className="size-6">
      ...
      <section className="bg-[#DAFFF6] w-full min-h-screen flex justify-center items-center text-[#006B6C] pl-10">
        ...
        <figure className="relative w-[70%] h-full overflow-hidden flex justify-center items-start">
          <Image width={1000} className="w-[40%] top-20 right-0" height={1000} src={'https://s.pinimg.com/webapp/future-home-vibes-adb19e98.png'} alt="" />
          <p className="absolute top-[5%] font-bold text-5xl text-white text-left px-4 py-2">Helechos en tu <br /> futuro hogar <br /> que dan buen <br /> rollo</p> 
          <div className="absolute bottom-4 flex space-x-4">
            <image width={300} height={300} className="w-[80px] h-[100px] rounded-full border-2 border-white" src={"https://s.pinimg.com/webapp/future-home1-b8bc36e8.png"} alt="" />
            <image width={300} height={300} className="w-[80px] h-[100px] rounded-full border-2 border-white" src={"https://s.pinimg.com/webapp/future-home2-31c812cc.png"} alt="" />
            <image width={300} height={300} className="w-[80px] h-[100px] rounded-full border-2 border-white" src={"https://s.pinimg.com/webapp/future-home3-037e8d49.png"} alt="" />
          </div>
        </figure>
        <figure>
